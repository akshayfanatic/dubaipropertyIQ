...
export function CitiesSearchFilter() {
  ...
  return (
    <FormProvider {...methods}>
      <FilterFieldSet>
        {/* Search field - filters cities by name */}
        <Controller name="search" control={control} render={({ field }) => <SearchInput value={field.value} onChange={field.onChange} placeholder="Search cities..." className="max-w-sm" />} />
