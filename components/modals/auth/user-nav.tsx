        ...
        <Sheet>
          ...
          <SheetContent side="right" className="w-70">
            <SheetHeader className="border-b pb-4">
              ...
              <SheetDescription className="sr-only">Account settings and sign out option</SheetDescription>
            ...
            <nav className="flex flex-col gap-2 mt-4">
              <Link href="/customer" className="flex items-center gap-3 rounded-lg px-3 py-3 hover:bg-primary/10 transition-colors">
