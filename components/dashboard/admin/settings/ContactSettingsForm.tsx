    ...
    <WidgetCard icon={Phone} title="Contact Settings" description="Manage your contact information displayed across the site.">
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="space-y-6">
          <TextInput id="email" label="Email Address" required type="email" placeholder="info@dubaipropertyiq.com" error={errors.email?.message} {...register('email')} />

          <TextInput id="phone" label="Phone Number" required type="tel" placeholder="+971 4 123 4567" error={errors.phone?.message} {...register('phone')} />

          <TextInput id="whatsapp" label="WhatsApp Number" required type="tel" placeholder="+971 50 123 4567" error={errors.whatsapp?.message} {...register('whatsapp')} />
