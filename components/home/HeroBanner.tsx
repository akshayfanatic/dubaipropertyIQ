  ...
  return (
    <section className="relative min-h-150 w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-150 flex-col items-center justify-center px-4 py-16 text-center lg:px-8">
        ...
        <h1 className="mb-4 max-w-3xl text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl animate-in slide-in-from-bottom-8 fade-in animation-duration-1000 delay-200 animation-ease-out fill-mode-both">
          <Typewriter speed={200} loop text={headline} />
          {/* {headline} */}
        </h1>

        {/* Subtext - fade in with delay */}
        <p className="mb-8 max-w-2xl text-base text-white/80 md:text-lg animate-in slide-in-from-bottom-6 fade-in animation-duration-1000 delay-300 animation-ease-out fill-mode-both">{subtext}</p>
