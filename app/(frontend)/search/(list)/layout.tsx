    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="w-full space-y-6 text-primary-foreground">
          ...
          <section
            className="w-full max-w-5xl rounded-xl border border-border/80 bg-card p-3 shadow-md sm:p-4 [&_button]:text-foreground [&_input]:text-foreground **:data-placeholder:text-muted-foreground"
      ...
      <div className="max-w-294 mx-auto flex w-full flex-col gap-6 px-4 pb-6 sm:px-6 sm:pb-8 lg:px-8 lg:pb-10">
        <div className="grid gap-6 lg:grid-cols-[18rem_minmax(0,1fr)] lg:items-start xl:grid-cols-[19rem_minmax(0,1fr)] xl:gap-8">
          <aside className="rounded-xl border bg-card p-4 shadow-sm lg:sticky lg:top-20 lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto sm:p-5">
            <SidebarFilters />
          </aside>
