...
export function AuthFooter({ prefix = 'By continuing, you agree to our' }: AuthFooterProps) {
  return (
    <p className="text-center text-xs text-muted-foreground">
      {prefix}{' '}
      <Link href="/pages/terms-conditions" className="underline-offset-2 transition-colors hover:text-foreground hover:underline">
        Terms of Service
      </Link>{' '}
      and{' '}
      <Link href="/pages/privacy-policy" className="underline-offset-2 transition-colors hover:text-foreground hover:underline">
        Privacy Policy
      </Link>
    </p>
  );
